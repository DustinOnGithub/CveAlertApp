...
class MyCves : Cves() {
    ...
    fun generateDbCves(subscriptionId: Int): List<com.cvealert.cvealert.database.cve.Cve> {

        val generatedCves: MutableList<com.cvealert.cvealert.database.cve.Cve> = mutableListOf()
        var newCve: com.cvealert.cvealert.database.cve.Cve
        ...
        result?.cveItems?.forEach {
            ...
            //todo: null safe
            newCve = com.cvealert.cvealert.database.cve.Cve(
                cve = getCveId(it),
